    ...
    return (
      <div className="section-share section-about">
        <div className="section-about-header">
          TRUYỀN THÔNG NÓI GÌ VỀ DŨNG ĐẸP TRAI
        </div>
        <div className="section-about-content">
          ...
          <div className="content-right">
            <p>
              ...
              và react để tạo dữ liệu thật cho trang home design này. Cụ thể và
              chi tiết các bạn cùng xem video nhé. Demo nhanh sản phẩm đạt được
              khi kết thúc video, các bạn xem tại 0:47 ❤
            </p>
          </div>
        </div>
      </div>
